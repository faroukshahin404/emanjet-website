                          ...
                          <div class="box">
                            <div class="box-body">
                              <div class="d-flex justify-content-between align-items-center">
                                  ...
                                  <div class="bg-success px-30 py-5 text-center rounded"><i class="ti-arrow-up text-white"></i></div>
                              </div>
                            </div>
                                  ...
                                  <div class="box no-shadow mb-0 bg-img rounded-0" data-overlay="5" style="background-image: url(../images/gallery/landscape7.jpg)">
                                      ...
                                      <div class="box-body">
                                          <div class="text-end mt-100 pt-25">
                                              <h3 class="text-white"><small class="me-10"><i class="fa fa-commenting"></i></small> 3</h3>
                                              <h2 class="text-white"><small class="me-10"><i class="fa fa-heart"></i></small> 23</h2>
                                              <h1 class="text-white"><small class="me-10"><i class="fa fa-eye"></i></small> 189</h1>
                                          </div>
                                      </div>
                                  </div>
                              </div>
              ...
              <div class="col-xl-6 col-12">
                  ...
                  <div class="box bg-warning">
                      <div class="box-body">
                          ...
                          <button type="button" class="waves-effect waves-light btn btn-outline btn-rounded btn-dark float-end">SAVE</button>
                      </div>
                  </div>
                  <div class="box">
                          ...
                          <div class="row">
                              <div class="col-lg-4 col-12">
                                  <div class="p-15">
                                      ...
                                      <div class="mt-30">
                                          <h4>Status: Live</h4>
                                          <p class="mb-0 fw-700"><i class="ti-location-pin text-danger fs-16"></i> <span class="fs-12">12 Osborne Drive Suite 845</span></p>
                                          <div class="mt-40">
                                          ...
                                          <div class="mt-40">
                                              ...
                                              <div class="progress">												
                                                  <div class="progress-bar progress-bar-warning progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
                                                    <span class="sr-only">60% Complete (warning)</span>
                                                  </div>
                                              </div>
                                          </div>
