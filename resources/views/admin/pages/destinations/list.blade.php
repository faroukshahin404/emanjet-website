            ...
            @foreach ($results as $item)
                <tr>
                    ...
                    <td class="text-center">
                        <!-- Edit Button -->
                        <a href="{{ route('admin.destinations.edit', $item->id) }}" class="btn btn-default btn-sm">
                            <i class="fa fa-edit"></i>
                        </a>

                        <!-- Delete Button -->
                        <form action="{{ route('admin.destinations.destroy', $item->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
