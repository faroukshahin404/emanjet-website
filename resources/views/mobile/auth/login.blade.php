    ...
    <div class="container mo-view mb-5 mt-3 px-4">
        <div class="row">
            <div class="d-flex justify-content-between align-items-center">
                <div></div>
                <p class="m-0 fs-25 text-black">تسجيل الدخول</p>
                <div></div>
            </div>
            ...
            <form action="{{ route('auth.postLogin') }}" method="POST" class="login-form">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="text"
                               class="form-control rounded-6 ps-4 @error('mobile') is-invalid @enderror"
                               id="mobile"
                               name="mobile"
                ...
                <div class="text-end mb-3">
                    <a href="{{ route('auth.forgotPassword') }}" class="text-main">نسيت كلمة المرور؟</a>
                </div>

                <div class="form-group">
                    <button type="submit" class="btn btn-main w-100 rounded-6">دخول</button>
                </div>

                <div class="text-center mt-3">
                    <p class="text-muted mb-0">ليس لديك حساب؟</p>
                    <a href="{{ route('auth.register') }}" class="text-main">تسجيل جديد</a>
                </div>
            </form>
        </div>
    </div>
