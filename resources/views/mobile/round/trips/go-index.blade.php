    ...
    <div class="wow animate__animated animate__fadeIn">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="text-center">
                <h5 class="m-0 fw-800 text-black">{{ __('Departure Trip') }}</h5>
                    ...
                    <a href="{{ route('mobile.round.back-trips', array_merge(request()->all(), ['go_trip_id' => $trip->id])) }}"
                        ...
                        <div class="bg-white rounded-5 shadow-premium border border-light-subtle p-3 mb-3 position-relative overflow-hidden">
                            ...
                            <div class="d-flex align-items-center justify-content-between pt-3 border-top border-light-subtle">
                                ...
                                <span class="text-main fw-800" style="font-size: 12px;">{{ __('Select Back') }} <i class="fas fa-chevron-{{ app()->getLocale() == 'ar' ? 'left' : 'right' }} small ms-1"></i></span>
                            </div>
                        </div>
                    </a>
                @endforeach
