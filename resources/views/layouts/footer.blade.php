    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-md-6 offset-lg-1">
                <h5 class="footer-links-top">{{ $footerAbout['quick-links-title'] ?? __('Quick Links') }}</h5>
            ...
            <div class="col-lg-2 col-md-6">
                <h5 class="footer-links-top">{{ $footerAbout['support-title'] ?? __('Support') }}</h5>
                <div class="footer-nav">
            ...
            <div class="col-lg-4 col-md-6 footer-newsletter-column">
                ...
                <p class="small opacity-75 mb-4">{{ $newsletter['description'] ?? __('Subscribe to our newsletter for the latest updates and offers.') }}</p>

                <form action="#" class="mb-4">
                    <div class="footer-input-group">
                        <input type="email" placeholder="{{ $newsletter['email-placeholder'] ?? __('Your Email') }}" required>
                        <button type="submit" class="footer-join-btn">
                            {{ $newsletter['button-text'] ?? __('Join') }}
                        </button>
                    </div>
                </form>
